...
class ScheduleController extends ClientApiController
{
    ...
    public function store(StoreScheduleRequest $request, Server $server)
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Created Schedule "'.$request->input('name').'".');
    ...
    public function update(UpdateScheduleRequest $request, Server $server, Schedule $schedule)
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Updated Schedule "'.$request->input('name').'".');
    ...
    public function execute(TriggerScheduleRequest $request, Server $server, Schedule $schedule)
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Executed Schedule "'.$schedule->name.'".');
    ...
    public function delete(DeleteScheduleRequest $request, Server $server, Schedule $schedule)
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Deleted Schedule "'.$schedule->name.'".');
