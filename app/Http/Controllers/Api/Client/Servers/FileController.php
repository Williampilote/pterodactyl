...
class FileController extends ClientApiController
{
    ...
    public function download(GetFileContentsRequest $request, Server $server)
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Downloaded "'.$request->get('file').'" File.');
    ...
    public function write(WriteFileContentRequest $request, Server $server): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Edited the File "'.$request->get('file').'".');
    ...
    public function create(CreateFolderRequest $request, Server $server): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Created "'.$request->input('name').'" Folder.');
    ...
    public function rename(RenameFileRequest $request, Server $server): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Renamed File/Folder from "'.$value.'".');
    ...
    public function copy(CopyFileRequest $request, Server $server): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Copied "'.$request->input('location').'" File.');
    ...
    public function compress(CompressFilesRequest $request, Server $server): array
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Compressed '.$data.' Files.');
    ...
    public function decompress(DecompressFilesRequest $request, Server $server): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Decompressed "'.$request->input('file').'" File.');
    ...
    public function delete(DeleteFileRequest $request, Server $server): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Deleted '.$data.' Files.');
    ...
    public function chmod(ChmodFilesRequest $request, Server $server): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Chmod '.$data.'Files.');
    ...
    public function pull(PullFileRequest $request, Server $server): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Pulled "'.$request->input('directory').'" File.');
