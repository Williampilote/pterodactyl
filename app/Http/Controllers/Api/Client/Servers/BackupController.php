...
class BackupController extends ClientApiController
{
    ...
    public function store(StoreBackupRequest $request, Server $server): array
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Created Backup "'.$request->input('name').'".');
    ...
    public function delete(Request $request, Server $server, Backup $backup): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Deleted Backup "'.$backup->name.'".');
    ...
    public function restore(Request $request, Server $server, Backup $backup): JsonResponse
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Restored Backup "'.$backup->name.'".');
