...
class DatabaseController extends ClientApiController
{
    ...
    public function store(StoreDatabaseRequest $request, Server $server): array
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Created Database "'.$database->database.'".');
    ...
    public function rotatePassword(RotatePasswordRequest $request, Server $server, Database $database)
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Changed Password for "'.$database->database.'" Database.');
    ...
    public function delete(DeleteDatabaseRequest $request, Server $server, Database $database): Response
    {
        ...
        activity()
            ...
            ->log($user->name_first.' '.$user->name_last.' has Deleted Database "'.$database->database.'".');
