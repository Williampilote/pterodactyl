	...
	<div class="card card-profile">
		...
		<div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
			<div class="d-flex justify-content-between">
				<a href="/account" class="btn btn-sm btn-info  mr-9 ">{!! $BLang::get('edit_account') !!}</a>
				<a href="/account/api" class="btn btn-sm btn-default float-right">{!! $BLang::get('account_api') !!}</a>
			</div>
		</div>
				...
				<div class="col">
					<div class="card-profile-stats d-flex justify-content-center">
						<div>
							...
							<span class="description">{!! $BLang::get('balance_page') !!}</span>
						</div>
					</div>
				</div>
			</div>
