    ...
    <div class="col-xs-12">
          ...
          <form action="{{ route('admin.billing.pages.save') }}" method="POST">
            ...
            <div class="box box-primary">
              <div class="box-header with-border">
                <div class="form-group">
                  ...
                  <div class="input-group"><span class="input-group-addon">{{ config('app.url') }}/{{ config('billing.path') }}/p/</span>
            ...
            {{-- <div class="box box-primary">
              <div class="box-header with-border">
                <div class="form-group">
                  <label for="auth">Only auth users?</label>
                  <select class="form-control" id="auth" name="auth">
                    <option value="1" @if(isset($page) and $page->auth == 1) selected @endif>Enable</option>
                    <option value="0" @if(isset($page) and $page->auth == 0) selected @endif>Disable</option>
                  </select>
                </div>
              </div>
            </div> --}}
