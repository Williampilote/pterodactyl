        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="row align-items-center">
              <div class="col-12">
                <h3 class="mb-0">{!! $BLang::get('account_balance') !!}</h3>
              </div>
          ...
          <div class="card-body">
            <div class="nav-wrapper">
              <ul class="nav nav-pills nav-fill flex-column flex-md-row" id="tabs-icons-text" role="tablist">
                  ...
                  <li class="nav-item">
                      <a class="nav-link navs-btn mb-sm-3 mb-md-0 active " id="tabs-icons-text-paypal-tab" data-toggle="tab" href="#tabs-icons-text-paypal" role="tab" aria-controls="tabs-icons-text-paypal" aria-selected="true"><i class="ni ni-cloud-upload-96 mr-2"></i>{!! $BLang::get('paypal') !!}</a>
                  </li>
                  @endif @endisset
                  @isset($settings['stripe_gateway'])@if( $settings['stripe_gateway'] == "true")
                  <li class="nav-item">
                      <a class="nav-link navs-btn mb-sm-3 mb-md-0" id="tabs-icons-text-stripe-tab" data-toggle="tab" href="#tabs-icons-text-stripe" role="tab" aria-controls="tabs-icons-text-stripe" aria-selected="false"><i class="ni ni-bell-55 mr-2"></i>{!! $BLang::get('stripe') !!}</a>
                  </li>
                  @endif @endisset
                  <li class="nav-item">
                    <a class="nav-link navs-btn mb-sm-3 mb-md-0" id="tabs-icons-text-info-tab" data-toggle="tab" href="#tabs-icons-text-info" role="tab" aria-controls="tabs-icons-text-info" aria-selected="false"><i class="ni ni-bell-55 mr-2"></i>{!! $BLang::get('billing_information') !!}</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="tab-content" id="myTabContent">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        <label class="form-control-label" for="balance">{!! $BLang::get('amount_info') !!}</label>
                  ...
                  <form action="{{ route('billing.balance.stripe') }}" method="post" name="cardpayment" id="payment-form">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                          ...
                          <div class="col-lg-4">
                            <label class="form-label">{!! $BLang::get('year') !!}</label>
                          ...
                          <div class="col-lg-4">
                            <label class="form-label">{!! $BLang::get('cvv') !!}</label>
                    ...
                    <div class="button-style">
                      ...
                      <button class="btn btn btn-primary submit" style="width: 100%;">{!! $BLang::get('pay_now') !!}</button>
                    </div>
                  </form>
              </div>
              @endif @endisset
              ...
              <div class="tab-pane fade" id="tabs-icons-text-info" role="tabpanel" aria-labelledby="tabs-icons-text-info-tab">
                ...
                <form action="{{ route('billing.user.update') }}" method="POST">
                  @csrf
                  <h6 class="heading-small text-muted mb-4">{!! $BLang::get('billing_information') !!}</h6>
                  <div class="pl-lg-4">
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-username">{!! $BLang::get('username') !!}</label>
                          <input type="text" id="input-username" class="form-control" placeholder="Username" value="{{ Auth::user()->username }}" disabled>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-email">{!! $BLang::get('email') !!}</label>
                    ...
                    <div class="row">
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-first-name">{!! $BLang::get('first_name') !!}</label>
                          <input type="text" id="input-first-name" class="form-control" placeholder="First name" value="{{ Auth::user()->name_first }}" disabled>
                        </div>
                      </div>
                      <div class="col-lg-6">
                        <div class="form-group">
                          <label class="form-control-label" for="input-last-name">{!! $BLang::get('last_name') !!}</label>
                  ...
                  <div class="pl-lg-4">
                    <div class="row">
                      <div class="col-md-12">
                        <div class="form-group">
                          <label class="form-control-label" for="input-address">{!! $BLang::get('address') !!}</label>
                    ...
                    <div class="row">
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="form-control-label" for="input-city">{!! $BLang::get('city') !!}</label>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="form-control-label" for="input-country">{!! $BLang::get('country') !!}</label>
                      ...
                      <div class="col-lg-4">
                        <div class="form-group">
                          <label class="form-control-label" for="input-country">{!! $BLang::get('postal_code') !!}</label>
                          <input type="number" id="input-postal-code" class="form-control" name="postal_code" placeholder="@if(isset($billding_user->postal_code)){{ $billding_user->postal_code }} @else Postal code @endif">
                        </div>
                      </div>
                    </div>
                  </div>
                  <!-- Button -->
                  <button type="submit" class="btn btn-primary" style="width: 100%"><strong>{!! $BLang::get('update_billing_nformation') !!}</strong></button>
                </form>
