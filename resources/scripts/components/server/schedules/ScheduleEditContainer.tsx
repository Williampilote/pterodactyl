...
const CronBox = ({ title, value }: { title: string; value: string }) => (
    <div css={tw`rounded p-3`} className='CronItem'>
        <p css={tw`text-sm`}>{title}</p>
            ...
            <ScheduleContainer>
                ...
                {!schedule || isLoading ?
                    ...
                    <>
                        ...
                        <div>
                            <div css={tw`sm:flex items-center p-3 sm:p-6 border-b-4 rounded-t`} className='mainContainer'>
                                <div css={tw`flex-1`}>
