...
import { faCogs, faHome, faUserCircle, faSignOutAlt, faTerminal, faFolder, faDatabase, faCalendar, faUsers, faArchive, faNetworkWired, faPlayCircle, faExternalLinkAlt } from '@fortawesome/free-solid-svg-icons';
